...
__global__ void bogo_sort_matv2(int* data, int size, int* output, int* block_permutation_counts) {
    ...
    __align__(256) extern __shared__ uint8_t permutation_matrix[PERMUTATION_MATRIX_32x32_FLAT_LENGTH_1024 * 2]; // two 32x32 arrays
    ...
    const int CORE_MATRIX_HEIGHT = 16;
    const int WORD_BYTES = 4;
    const int SHIFT_RIGHT = 16;
    const int SHIFT_DOWN = 8 * 16;
